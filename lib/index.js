var
	...
	BrandProxy = require('./brand'),
	CampaignProxy = require('./campaign'),
...
module.exports = (function (self) {
	...
	self.configure = (clientId, secret, options) => {
		...
		self.brand = new BrandProxy(options.brand, key.ensureAuthHeaders);
		self.campaign = new CampaignProxy(options.campaign, key.ensureAuthHeaders);
		...
		self.options = () => ({
			...
			brand: self.brand.settings(),
			campaign: self.campaign.settings(),
