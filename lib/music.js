...
const
	...
	DEFAULT_V2_HOST = 'curio-music-api.apps.playnetwork.com',
	DEFAULT_SECURE = true,
	EVENT_ERROR = 'error',
...
module.exports = function (musicOptions, ensureAuthHeaders, self) {
	...
	settings.collection.secure =
		validation.isEmpty(musicOptions) || 
		validation.isEmpty(musicOptions.collection) || 
		typeof musicOptions.collection.secure !== 'boolean' ?
			DEFAULT_SECURE :
	...
	settings.station.secure =
		validation.isEmpty(musicOptions) || 
		validation.isEmpty(musicOptions.station) ||
		typeof musicOptions.station.secure !== 'boolean' ?
			DEFAULT_SECURE :
	...
	settings.track.secure =
		validation.isEmpty(musicOptions) || 
		validation.isEmpty(musicOptions.track) ||
		typeof musicOptions.track.secure !== 'boolean' ?
			DEFAULT_SECURE :
	...
	settings.v2.secure =
		validation.isEmpty(musicOptions) ||
		validation.isEmpty(musicOptions.v2) ||
		typeof musicOptions.v2.secure !== 'boolean' ?
			DEFAULT_SECURE :
